...
class DataIngestion:
    def __init__(self):
        self.ingestion= DataIngetionConfig()

    def initiate_data_ingestion(self):
        try:
            df = pd.read_csv("C:\\Projects\\MLproject\\artifacts\\data.csv")
            ...
            train_set.to_csv(self.ingestion.train_data_path)
            test_set.to_csv(self.ingestion.test_data_path)
